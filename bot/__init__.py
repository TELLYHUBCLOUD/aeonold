...
QUEUE_DOWNLOAD = environ.get('QUEUE_DOWNLOAD', '4')
QUEUE_DOWNLOAD = '' if len(QUEUE_DOWNLOAD) == 0 else int(QUEUE_DOWNLOAD)

QUEUE_UPLOAD = environ.get('QUEUE_UPLOAD', '1')
...
IMAGES = (IMAGES.replace("'", 'https://graph.org/file/b39a52cd50563cb23df8a.jpg').replace('"', '').replace(
